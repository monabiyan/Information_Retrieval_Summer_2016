...
def dictionary_into_2sorted_list_and_save(path_to_load,path_to_save):
    global new_graph_inlinks
    global new_graph_outlinks
    ...
    for i in range(0,len(mykey)):
        ...
        try:
            sentence = ((mykey[i]) + '   =      '  + str(myvalue[i]) +'         '+ str(len(new_graph_inlinks[mykey[i]]))+'\n').encode('utf8')
            print('good '+str(len(new_graph_inlinks[mykey[i]])))
            g.write(sentence)
            # +'   ' + str(len(new_graph_outlinks[mykey[i]]))
        except:
            print('baddddd')
...
# new_graph_inlinks = read_dictionary('/Users/mohsennabian/HW4/new_graph_inlinks.txt')
# new_graph_outlinks = read_dictionary('/Users/mohsennabian/HW4/new_graph_outlinks.txt')
# print(len(base_dict))
#
# print('hi')
...
hub = read_dictionary('/Users/mohsennabian/HW4/hub_dict.txt')
authority= read_dictionary('/Users/mohsennabian/HW4/authority_dict.txt')

new_graph_inlinks = read_dictionary('/Users/mohsennabian/HW4/new_graph_inlinks.txt')
new_graph_outlinks = read_dictionary('/Users/mohsennabian/HW4/new_graph_outlinks.txt')
for url in hub.keys():
    try:
        print(len(new_graph_inlinks[url]))
    except:
        print('bad')
